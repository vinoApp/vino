 ...
 * Time: 7:38 PM
 */
public class CellarRecordRowMapper implements RowMapper<WineCellarRecord> {

    @Override
    public WineCellarRecord mapRow(ResultSet resultSet, int i) throws SQLException {
        ...
        record.setBottle(bottle);
        record.setQuantity(resultSet.getInt(DataRowsBundle.BOTTLE_QTY));
