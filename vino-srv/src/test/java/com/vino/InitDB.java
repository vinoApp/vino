...
public class InitDB {
    ...
    private static final CellarBusiness CELLAR_BUSINESS = FACTORY.getComponent(Name.of(CellarBusiness.class));
    ...
    private void addCellarRecord(Reference<WineCellar> cellar, Reference<WineDomain> domain, int vintage, int qty) {
        WineCellarRecord record = new WineCellarRecord()
                ...
                .setDomain(domain)
                .setVintage(vintage);
        CELLAR_BUSINESS.onCellarMovement(cellar.getKey(), new Movement()
                        .setMovementType(Movement.Type.IN)
                        .setRecord(record)
                        .setAmount(qty)
